  ...
  return (
    <main className="admin-shell wide">
      ...
      <header className="event-admin-header">
        <div>
          <div className="section-kicker">{event.restaurant_name}</div>
          <h1>{event.name}</h1>
          <p>
        ...
        <Link
          className="button button-primary scanner-launch"
          href={`/admin/events/${event.id}/scanner`}
        >
          <Camera size={19} /> Open scanner
        </Link>
      </header>
      ...
      <section className="stat-grid">
        ...
        <div className="stat-card">
          ...
          <strong>{registrations.length - checkedIn}</strong>
        </div>
        <div className="stat-card">
          <span>Walk-ins</span>
      ...
      <section className="event-tools-grid">
        <div className="panel">
          <div className="panel-title">
            ...
            <div>
              <h2>Club links</h2>
              <p>Each club gets its own tracked registration link.</p>
            </div>
          </div>
          <ClubManager
            eventId={event.id}
        ...
        <div className="panel venue-panel">
          <div>
            <div className="section-kicker">Venue signup QR</div>
            <h2>Walk-in registration</h2>
            <p>
              Put this QR at the entrance for students who did not register beforehand.
            </p>
          </div>
